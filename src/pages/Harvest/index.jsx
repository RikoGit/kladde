        ...
        <ul className={styles['harvest-list']}>
                ...
                <label htmlFor="harvest__checkbox-1" className={styles.harvest__label}>
                    ...
                    <span className={styles.harvest__info}>
                        ...
                        <span className={styles.harvest__text}>
                            По содержанию каротина морковь уступает лишь сладкому перцу. Морковь и
                            морковный сок назначают больным с гипо- и авитаминозом А.
                            Экспериментально установлено, что морковь активизирует внутриклеточные
                            окислительно-восстановительные процессы, регулирует углеводный обмен,
                            обладает антисептическим, противовоспалительным, обезболивающим и
                            ранозаживляющим свойствами. Лечение морковным соком рекомендуют при
                            заболеваниях, связанных с нарушением минерального обмена (жёлчнокаменная
                            болезнь, метаболические полиартриты), показано употребление морковного
                            сока в первые дни после инфаркта миокарда, а также для беременных
                            женщин, кормящих матерей, детей. Свежий морковный сок используется также
                            при анемии, гипоацидных гастритах. Однако свежая морковь и морковный сок
                            противопоказаны при обострении язвенной болезни и энтеритах.
                        </span>
                    </span>
                </label>
            ...
            <li className={styles.harvest}>
                ...
                <label htmlFor="harvest__checkbox-2" className={styles.harvest__label}>
                    <img alt="" src="images/harvest/1.jpg" className={styles.harvest__preview} />
                    <span className={styles.harvest__info}>
            ...
            <li className={styles.harvest}>
                ...
                <label htmlFor="harvest__checkbox-5" className={styles.harvest__label}>
                    <img alt="" src="images/harvest/2.jpg" className={styles.harvest__preview} />
                    <span className={styles.harvest__info}>
            ...
            <li className={styles.harvest}>
                ...
                <label htmlFor="harvest__checkbox-6" className={styles.harvest__label}>
                    <img alt="" src="images/harvest/11.jpeg" className={styles.harvest__preview} />
                    <span className={styles.harvest__info}>
            ...
            <li className={styles.harvest}>
                ...
                <label htmlFor="harvest__checkbox-9" className={styles.harvest__label}>
                    <img alt="" src="images/harvest/14.jpg" className={styles.harvest__preview} />
                    <span className={styles.harvest__info}>
            ...
            <li className={styles.harvest}>
                ...
                <label htmlFor="harvest__checkbox-12" className={styles.harvest__label}>
                    <img alt="" src="images/harvest/16.jpg" className={styles.harvest__preview} />
                    <span className={styles.harvest__info}>
